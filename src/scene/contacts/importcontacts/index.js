...
class ImportContacts extends React.Component {
    ...
    handleSubmit() {
        ...
        .then((res)=>{
            toast.success('Succeed uploading ' + this.state.parsed.length + ' contacts', {autoClose: 10000});
        }).catch((err) => {
		...
		return (
			<div id="import-leads">
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div className="">
                        <div className="top">
                            <span className="font-bold h4 pull-left" id="title">Import Contact</span>
                        </div>
                        <div className="card">
                            <div className="body">
                                <div className="row clearfix  m-t-60 m-b-60 m-r-100 m-l-100">
                                    ...
                                    <div className="col-md-12">
                                        <div className="font-bold h4 text-center">Import Contact</div>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <NavLink to="/contacts"><button className="btn btn-default btn-md waves-effect">CANCEL</button></NavLink>
