...
class Leads extends React.Component {
    constructor() {
        ...
        this.saveLeads = this.saveLeads.bind(this);
    ...
    render() {
        ...
        contacts.map((contact, key) => {
            this.state.template.leads.map((lead) => {
                if (lead == contact.id && contact.is_lead == true) {
                    con.push(contact);
                }
            })
        })
    		...
    		<div>
                <div className="item__row item__row--content">
                    <div className="flex-box p-l-15" style={{alignItems: 'center'}}>
                        <span className="heading avatar-heading m-r-15">Leads</span>
                    ...
                    <div className="btn-group custom-group">
                        <button 
                           ...
                           >
                            <span className="p-r-10">Leads</span>
